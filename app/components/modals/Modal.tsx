...
const Model: React.FC<ModalProps> = ({
    ...
    <>
     ...
     <div className='relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto 
                 md:h-auto'>
                    {/* contenet */}
    <div className={`translate duration-300 h-full ${showModal ? 'translate-y-0 opacity-100' :
        ...
        <div className='translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg 
                        ...
                        outline-none focus:outline-none  '>
                            {/* header */}
          <div className='flex items-center p-6 rounded-t justify-center relative border- 
                             center border-b-[1px] '>
       <button onClick={handleClose} className='p-1 border-0 hover:opacity-70 
